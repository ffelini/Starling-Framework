...
/** A Tween animates numeric properties of objects. It uses different transition functions
    ...
    public class Tween extends EventDispatcher implements IAnimatable
    {
        ...
        protected var mProgress:Number;
        protected var mDelay:Number;
        protected var mRoundToInt:Boolean;
        protected var mNextTween:Tween;
        protected var mRepeatCount:int;
        protected var mRepeatDelay:Number;
        protected var mReverse:Boolean;
        protected var mCurrentCycle:int;
