...
public class DisplayObject extends EventDispatcher implements IDisplayObject {
    ...
    /** Helper objects. */
    protected static var sAncestors:Vector.<DisplayObject> = new <DisplayObject>[];
    ...
    public function getParent():IDisplayObjectContainer {
